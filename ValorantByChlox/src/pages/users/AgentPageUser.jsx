...
function AgentPageUser() {
  ...
  const [selectedAgentAbilities, setSelectedAgentAbilities] = useState(null);
  ...
  const handleProfilPictureClick = (agent) => {
    ...
    setSelectedAgentAbilities(agent.abilite);
  };
